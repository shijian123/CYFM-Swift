...
/// 最外层的Model
struct CYFMHomeRecommendModel: HandyJSON {
    var msg:String?
    var ret:Int = 0
    var code:String?
    var list:[CYFMRecommendModel]?
}

/// 里层的Model
struct CYFMRecommendModel: HandyJSON {
    var bottomHasMore: Bool = false
    var hasMore: Bool = false
    var list: [CYFMRecommendListModel]?
    var loopCount: Int = 0
    var moduleId: Int = 0
    ...
    var target: CYFMTarget?
    var recWords: [CYFMRecWords]?
    
    var categoryId: Int = 0
    var direction: String?
    var keywords: [CYFMKeywords]?
}

struct CYFMRecommendListModel: HandyJSON {
    var albumId: Int = 0
    var categoryId: Int = 0
...
struct CYFMTarget: HandyJSON {
    var groupId: Int = 0
    var categoryId: Int = 0
}

struct CYFMRecWords: HandyJSON {
    var contentType: String?
    var properties:CYFMProperties?
    var title: String?
}

struct CYFMProperties: HandyJSON {
    var isPaid: Bool = false
    var type: String?
    var uri: String?
    var albumId: Int = 0
...
struct CYFMFocusModel: HandyJSON {
    var data: [CYFMBannerData]?
    var responseId: Int = 0
    var ret : Int = 0
}

struct CYFMBannerData: HandyJSON {
    var adId: Int = 0
    var adType: Int = 0
...
struct CYFMSquareModel: HandyJSON {
...
struct CYFMTopBuzzModel: HandyJSON {
    var albumId: Int = 0
...
struct CYFMGuessYouLikeModel: HandyJSON {
    var albumId: Int = 0
    var categoryId: Int = 0
    var commentsCount: Int = 0
    var infoType: String?
...
struct CYFMPaidCategoryModel: HandyJSON {
    var albumId: Int = 0
    var categoryId: Int = 0
    var commentsCount: Int = 0
    var commentScore: CGFloat = 0.0
...
struct CYFMPlaylistModel: HandyJSON {
...
struct CYFMOneKeyListenModel: HandyJSON {
    var channelId: Int = 0
    var channelName: String?
    var cover: String?
    var coverRound: String?
    var onLineNum: Int = 0
    var recInfo: CYFMRecInfo?
}

struct CYFMRecInfo: HandyJSON {
    var recSrc: String?
    var recTrack: String?
}

struct CYFMLiveModel: HandyJSON {
...
struct CYFMRecommnedAdvertModel: HandyJSON {
    var shareData: CYFMAdvertShareData?
    var isShareFlag: Bool = false
...
struct CYFMAdvertShareData: HandyJSON {
    var linkUrl: String?
