...
class CYFMRecommendNewsCell: UICollectionViewCell {
    private var topBuzz:[CYFMTopBuzzModel]?
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        layout.itemSize = CGSize(width: (CYFMScreenWidth - 150), height:40)
        let collectionView = UICollectionView.init(frame:CGRect(x:80,y:5, width:CYFMScreenWidth-150, height:40), collectionViewLayout: layout)
        layout.scrollDirection = UICollectionView.ScrollDirection.vertical
        collectionView.contentSize = CGSize(width: (CYFMScreenWidth - 150), height: 40)
        ...
        collectionView.register(CYFMNewsCell.self, forCellWithReuseIdentifier:"CYFMNewsCell")
...
extension CYFMRecommendNewsCell : UICollectionViewDelegate, UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return (self.topBuzz?.count ?? 0)*100
    }

    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell:CYFMNewsCell = collectionView.dequeueReusableCell(withReuseIdentifier: "CYFMNewsCell", for: indexPath) as! CYFMNewsCell
...
class CYFMNewsCell: UICollectionViewCell {
