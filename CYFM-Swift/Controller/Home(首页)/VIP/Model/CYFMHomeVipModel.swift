...
/// 首页VIP数据模型
struct CYFMHomeVipModel: HandyJSON {
    var msg: String?
    var ret: Int = 0
    var focusImages: CYFMFocusImagesModel?
    var serverMilliseconds: Int = 0
    var categoryContents: CYFMCategoryContentsModel?
}

struct CYFMFocusImagesModel: HandyJSON {
    var data:[CYFMFocusImagesData]?
    var responseId: Int = 0
    var ret: Int = 0
}
/// 滚动图片
struct CYFMFocusImagesData: HandyJSON {
    var adId: Int = 0
    var adType: Int = 0
...
struct CYFMCategoryContentsModel: HandyJSON {
    var list: [CYFMCategoryList]?
    var title: String?
}

/// 滚动按钮
struct CYFMCategoryBtnModel: HandyJSON {
    ...
    var title: String?
    var url: String?
    var properties : CYFMCategoryPropertiesModel?
}

struct CYFMCategoryPropertiesModel:HandyJSON {
    var isPaid:Bool = false
    var type:String?
    var uri:String?
}

struct CYFMCategoryList: HandyJSON {
    ...
    var list: [CYFMCategoryContents]?
    var moduleType: Int = 0
    var tagName: String?
    var title: String?
}

struct CYFMCategoryContents: HandyJSON {
