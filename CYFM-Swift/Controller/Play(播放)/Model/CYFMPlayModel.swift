...
struct CYFMPlayModel: HandyJSON {
    var ret: Int = 0
    var albumInfo: CYFMPlayAlbumInfo?
    var associationAlbumsInfo: [CYFMPlayAssociationAlbumsInfo]?
    var noCacheInfo: CYFMPlayNoCacheInfo?
    var trackInfo: CYFMPlayTrackInfo?
    var userInfo: CYFMPlayUserInfo?
}

struct CYFMPlayAlbumInfo: HandyJSON {
    var albumId: Int = 0
...
struct CYFMPlayAssociationAlbumsInfo: HandyJSON {
    var isDraft: Bool = false
    var albumId: Int = 0
    var uid: Int = 0
    var updatedAt: Int = 0
...
struct CYFMPlayNoCacheInfo: HandyJSON {
    var recAlbumsPanelTitle: String?
    var associationAlbumsInfo: [CYFMPlayAssociationAlbumsInfo]?
    var communityInfo: CYFMPlayCommunityInfo?
    var commentInfo: CYFMPlayCommentInfoList?
}

struct CYFMPlayCommentInfoList: HandyJSON {
    var list: [CYFMPlayCommentInfo]?
}

struct CYFMPlayCommentInfo: HandyJSON {
    var createdAt: Int = 0
    var id: Int = 0
    var likes: Int = 0
    ...
    var replies: [CYReplies]?
}

struct CYReplies: HandyJSON {
    var content: String?
    var nickname: String?
...
struct CYFMPlayCommunityInfo: HandyJSON {
...
struct CYFMPlayTrackInfo: HandyJSON {
    var albumId: Int = 0
...
struct CYFMPlayUserInfo: HandyJSON {
    var albums: Int = 0
